-- Fixa audit log trigger som försöker sätta ogiltig status "rejected"
-- Problemet: Triggern försöker sätta status till "rejected" men det finns inte i enum
-- Lösning: Mappa "rejected" action till "cancelled" status
...
'Loggar statusändringar i event_audit_log. Action "rejected" mappar till status "cancelled".';

-- Verifiera att det fungerar
SELECT 'Audit log trigger uppdaterad! Test genom att godkänna/avböja ett event.' as status;
