...
export default function NewOrganizerPage() {
  ...
  const handleSave = async (publish: boolean = false) => {
    ...
    try {
      ...
      if (data && data[0]) {
        router.push(`/organizer-pages/${data[0].id}/edit?created=true`)
      }
    } catch (error) {
      ...
      if (error instanceof Error && error.message.includes('duplicate key')) {
        ...
        alert('Fel vid skapande av arrangörssida')
      }
    } finally {
      setSaving(false)
    }
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Ny Arrangörssida</h1>
              <p className="mt-1 text-sm text-gray-500">
                Skapa en ny SEO-sida för en arrangör
              </p>
            </div>
          </div>
                                  ...
                                  if (parent) {
                                    parent.innerHTML = `
                                      <div class="flex flex-col items-center justify-center h-full text-gray-400">
                                        ...
                                        <span class="text-xs">Bild kunde inte laddas</span>
                                      </div>
                                    `
                                  }
                                }}
